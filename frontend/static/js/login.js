let url = "https://kjy040wenc.execute-api.ap-northeast-2.amazonaws.com/Prod"
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response['result'] == 'success') {
                ...
                window.location.replace("/serverless_helpmymenu/frontend/templates/index.html")
            } else {
                alert(response['msg'])
            }
        }
